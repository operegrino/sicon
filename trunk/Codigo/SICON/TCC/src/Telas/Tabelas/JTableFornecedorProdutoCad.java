 ...
 * @author Jonathan
 */
public class JTableFornecedorProdutoCad extends AbstractTableModel{
    
    private Vector ListaFornecedorProduto;
    
    public JTableFornecedorProdutoCad(Vector Lista){
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (columnIndex == 4) {            
            return ((Vector)ListaFornecedorProduto.get(rowIndex)).get(7); 
        } return ""; 
