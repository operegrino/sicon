...
public class TelaInicio2 extends javax.swing.JFrame {
    ...
    private void CriarMenuItemUnidadeMedida(){
        ...
        jmnSeguranca.add(jmiUnidadeMedida);
    ...
    private void CriarMenuItemFichaTecnica(){
        ...
        jmnSeguranca.add(jmiFichaTecnica);
    ...
    private void CriarMenuItemOrdemProducao(){
        ...
        jmnSeguranca.add(jmiOrdemProducao);
    ...
    private void CriarMenuItemComposicaoCentesimal(){
        ...
        jmnSeguranca.add(jmiComposicaoCentesimal);
    ...
    private void CriarMenuItemContatoFornecedor(){
        ...
        jmnSeguranca.add(jmiContatoFornecedor);
    ...
    private void CriarMenuItemFornecedor(){
        ...
        jmnSeguranca.add(jmiFornecedor);
    ...
    private void CriarMenuItemPagamentoFornecedor(){
        ...
        jmnSeguranca.add(jmiPagamentoFornecedor);
    ...
    private void CriarMenuItemFornecedorProduto(){
        ...
        jmnSeguranca.add(jmiFornecedorProduto);
    ...
    private void CriarMenuItemAvaliacaoPedido(){
        ...
        jmnSeguranca.add(jmiAvaliacaoPedido);
    ...
    private void CriarMenuItemImportacao(){
        ...
        jmnSeguranca.add(jmiImportacao);
    ...
    private void initComponents() {
        ...
        jtpTelas.addTab("tab1", jInternalFrame1);
